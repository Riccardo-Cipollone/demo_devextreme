...
import { DxAutocompleteModule, DxButtonModule, DxDataGridModule, DxPopupModule, DxSelectBoxModule } from 'devextreme-angular';
...
@Component({
  selector: 'app-agenda',
  standalone: true,
  imports: [CommonModule, DxDataGridModule, DxButtonModule, DxPopupModule, DxSelectBoxModule, FormsModule, DxAutocompleteModule],
